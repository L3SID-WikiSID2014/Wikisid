...
my $idRequete;
my $requete=param("requete"); #Récupération de la requete dans l'url
...
print("<meta name=\"description\" content=\"Wiki GEEK SID - Recherche\" />\n");
print("<meta name=\"keywords\" content=\"Wiki GEEK SID Recherche\" />\n");
print("<title>Wiki GEEK SID - Recherche</title>\n");
print("</head>\n");
print("\n");
...
print ("<table><tr><td><abbr title=\"Wiki SID\"><img src=\"./bootstrap/img/logomini.jpg\" align=\"left\"></abbr>&nbsp;</td><td><form action=\"recherche.pl\" method=\"get\">\n");
print ("<input type=\"text\" class=\"form-control\"name =\"requete\" value=\"".$requete."\" size=\"60\" maxlength=\"30\"/></td><td>&nbsp;</td><td>\n");
print ("<input type=\"submit\" class=\"btn btn-primary\" value =\"Rechercher\">\n");
...
if ($requete ne ''){
	...
	($idRequete, $date, $heure)=&insererRequetes($requete);
	my @resultatRequete=&normalisationScores(&evaluerRequete($requete,$cheminCollection,$methodeCalcul));
